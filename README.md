...
| `min_date`               | Minimum date boundary for the chart. Dates before this are disabled and bars cannot be moved or resized before this date. | Any valid date string (e.g., `YYYY-MM-DD`).                                                                                                                                   | `null`                                              |
| `max_date`               | Maximum date boundary for the chart. Dates after this are disabled and bars cannot be moved or resized after this date.   | Any valid date string (e.g., `YYYY-MM-DD`).                                                                                                                                   | `null`                                              |

...
class I {
  ...
  bind_bar_events() {
    ...
    this.$svg.onclick = (d) => {
      ...
      a.forEach((w) => w.group.classList.remove("active")), l.classList.contains("left") ? i = !0 : l.classList.contains("right") ? o = !0 : l.classList.contains("bar-wrapper") && (t = !0), g.classList.add("active"), this.popup && this.popup.parent.classList.add("hidden"), this.popup && this.popup.parent.classList.add("hidden"), e = d.offsetX || d.layerX, d.offsetY || d.layerY, n = g.getAttribute("data-id"), a = [
        n,
